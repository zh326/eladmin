...
/**
 * @Description 对称加密（AES）工具类
 * @Author zhuhuan
 * @CreateDate 2020/3/24 18:25
 * @Version 1.0
 */
public class AESUtil {
    /**
     * 设置秘钥及初始化向量，可以通过getAESKey/getIvf方法生成
     * 秘钥长度等于AES_KEY的长度 * 8
     */
    private static final String AES_KEY = "FiNDc1MDUtOGUyZi00Zjg0LTliYjctMm";
    private static final String IV = "M0ZGUxMWUtNmQwNS";
    ...
    public static HashMap<String, String> getAESKeyAndIv() {
        ...
        aesKeyAndIv.put("aesKey", AESUtil.getAESKey());
    ...
    public static String encryptAES(String content){
        ...
        try {
            ciphertext = encryptAES(content.getBytes(),AES_KEY,IV);
    ...
    public static String decryptAES(String content){
        ...
        try {
            plaintext = decryptAES(content.getBytes(), AES_KEY,IV);
        } catch (NoSuchPaddingException e) {
            e.printStackTrace();
        } catch (NoSuchAlgorithmException e) {
            e.printStackTrace();
    ...
    public static void main(String[] args) {
        ...
        String content = "123456:abcdef,123456:abcdef,123456:abcdef,123456:abcdef,123456:abcdef,123456:abcdef";
        String cipherText = AESUtil.encryptAES(content);
